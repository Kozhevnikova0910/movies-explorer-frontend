    ...
    return (
        <section className="project">
            ...
            <div className="project__table">
                <div
                    className="project__table-block project__table-block_color_white project__table-block_bg_salad">1
                    неделя
                </div>
                <div
                    className="project__table-block project__table-block_color_black project__table-block_bg_white">4
                    недели
                </div>
